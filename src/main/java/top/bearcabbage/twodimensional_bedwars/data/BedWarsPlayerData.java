...
public class BedWarsPlayerData {
    ...
    public static void restoreBackup(ServerPlayerEntity player) {
        ...
        if (data != null) {
            ...
            if (data.contains("Health")) player.setHealth(data.getFloat("Health").orElse(20f));
            if (data.contains("Food")) player.getHungerManager().setFoodLevel(data.getInt("Food").orElse(20));
            if (data.contains("XpLevel")) player.experienceLevel = data.getInt("XpLevel").orElse(0); 
            if (data.contains("XpProgress")) player.experienceProgress = data.getFloat("XpProgress").orElse(0.0f);
